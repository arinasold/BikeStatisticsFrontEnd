...
You can take a look of web application here [here](https://helsinki-city-bike-web.herokuapp.com/) and see the server-side code  [here](https://github.com/arinasold/BikeStatisticsApp)
